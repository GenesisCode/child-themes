 ...
 *
 * @package     WDP_Genesis_Child
 * @since       1.0.0
 * @link        https://github.com/michaelmusgrove/WDP-Genesis-Child
 * @author      Michael Musgrove <musgrove@webdesignpop.com>
 * @copyright   Copyright (c) 2013, Michael Musgrove
...
class Child_Theme_Settings extends Genesis_Admin_Boxes {
	...
	function __construct() {
		...
		$default_settings = array(
			...
			'footer-right' => 'Site by <a href="http://webdesignpop.com">web design POP</a>',
		);
